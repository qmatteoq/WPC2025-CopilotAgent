...
public class TravelAgent
{
    ...
    private const string AgentInstructions = """
        ...
        You can talk to external API to get flights information. If you do not get any data, respond that you are having trouble getting flight information.
        ...
        When a customer asks a question about booking flight, first use the RetrievalPlugin to search the documents and find relevant information.
        Then, summarize the relevant information into a set of rules of related policies and the referenced documents.
        After that, use the MCP flight search tools to get real flight data. Don't ask for dates unless the user asks to specify them.
        Finally, combine the rules from documents and the data from MCP flight API to answer the user's question.
        The output should be summarization of policies with links of source document referenced, followed by an itinerary with each choice of flights valid, or with certain constraints.
